    ...
    return (
      ...
      alert(data.message);
        ...
        {({values,errors, isSubmitting, touched, handleChange, handleBlur, handleSubmit}) => (
          ...
          <Typography variant="h2" align="center" fontFamily={"Helvetica Neue"}>Admin Dashboard</Typography>
      <div>

      <Button 
          sx={{marginRight: 10, marginTop:2, marginLeft:50, marginBottom:5}}
          ...
          {show &&
          <>
            <div className= "form1" style={{marginTop: 35, marginLeft:"30%", marginBottom:20}}>
              <h1>Add a User</h1>
              ...
              />
              <ErrorMessage name="fullName" style={{color:"red", fontSize:'small'}} className="error-message" component="span" />
              ...
              />
              <ErrorMessage name="phoneNumber" style={{color:"red", fontSize:'small'}} className="error-message" component="span" />
                  ...
                  <TableBody>
                    {userData.map((a) => (
                      <TableRow key={a.id}>
                        ...
                        <TableCell>
                      <PersonRemoveIcon
                        onClick={() => deleteUser(a.id, a.fullName, a.phoneNumber, a.username)}/>
                      </TableCell>
                      </TableRow>
                    ))}
                  </TableBody>
